...
const initialState = {
    ...
    },], messages: [{id: 1, message: 'Hi', isMyMessage: false}, {id: 2, message: 'How are you?', isMyMessage: false}, {
    ...
    }, {id: 8, message: 'I was resting, I\'m just starting my part now', isMyMessage: true}], newMessageText: ''
};
